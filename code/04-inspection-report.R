...
ggsave("plots/insp_a - seed filling duration.tiff", plot = insp_a,
...
ggsave("plots/insp_b - phenology timeline.tiff", plot = insp_b,
...
ggsave("plots/insp_c - yield CV by scenario.tiff", plot = insp_c,
...
ggsave("plots/insp_d - spatial CV map.tiff", plot = insp_d,
...
ggsave("plots/insp_e - water balance summary.tiff", plot = insp_e,
...
ggsave("plots/insp_f - yield vs radiation.tiff", plot = insp_f,
       width = 16, height = 12, units = "cm", dpi = 300, compression = "lzw", bg = "white")
...
ggsave("plots/insp_g - blooming temperature.tiff", plot = insp_g,
       width = 16, height = 12, units = "cm", dpi = 300, compression = "lzw", bg = "white")
...
ggsave("plots/insp_h - RUE proxy.tiff", plot = insp_h,
       width = 18, height = 12, units = "cm", dpi = 300, compression = "lzw", bg = "white")

## ── ASSEMBLE PDF ──────────────────────────────────────────────────────────────

pdf("plots/inspection-report.pdf", width = 14, height = 10)
...
message("Inspection report written to plots/inspection-report.pdf")
