...
## Generates plots/simulation-report.pdf — a technical PDF documenting
## what was simulated, timing, coverage, and per-chunk diagnostics.
## Run from repo root: source("code/05-simulation-report.R")
## ═══════════════════════════════════════════════════════════════════════════
...
log_path     <- "intermediate-data/sim-run-log.csv"
results_path <- "intermediate-data/simulated-scenarios-df.rds"
summary_path <- "intermediate-data/run-summary.txt"
chunks_dir   <- "intermediate-data/sim-chunks"
...
out_pdf <- "plots/simulation-report.pdf"
