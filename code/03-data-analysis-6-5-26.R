...
save_map <- function(var, label, df_stars, ark, counties, xlim = c(360000, 570000)) {
  p <- ggplot() +
    ...
    facet_wrap(~scenario)
  ggsave(paste0("plots/wue_", var, ".tiff"), plot = p, width = 12, height = 15,
...
ggsave("plots/p1 - climate change without adaptation.tiff", plot = plot1,
...
ggsave("plots/p2 - temperature impacts.tiff", plot = temp.plot,
...
ggsave("plots/p3 - climate change with adaptation - summary.tiff", plot = plot3.1,
...
ggsave("plots/p4 - climate change with adaptation - map.tiff", plot = plot4,
       width = 15, height = 15, units = "cm", dpi = 600, compression = "lzw", bg = "white")
...
ggsave("plots/p5 - climate change with adaptation - merged.tiff", plot = plot5_merged,
...
ggsave("plots/p5 - environmental characterization.tiff", plot = plot5_env,
...
ggsave("plots/p6b - seed filling duration.tiff", plot = p6b,
...
ggsave("plots/p7 - phenology by scenario.tiff", plot = p7,
